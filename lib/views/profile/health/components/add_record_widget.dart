    ...
    return Padding(
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Text("Add Match Alert Record to show peoples about your relationship",style: TextStyle(fontSize: 32,fontWeight: FontWeight.bold,fontFamily: ''),textAlign: TextAlign.center,),
