...
class SelectHoursTime extends StatefulWidget {
  final int whichDay;

  const SelectHoursTime({Key? key, required this.whichDay}) : super(key: key);

  @override
  _SelectHoursTimeState createState() => _SelectHoursTimeState();
}

class _SelectHoursTimeState extends State<SelectHoursTime> {
  String day = 'Saturday';
