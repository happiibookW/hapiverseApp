...
class AddCardBusinessInfluencers extends StatefulWidget {
  const AddCardBusinessInfluencers({Key? key}) : super(key: key);

  @override
  State<AddCardBusinessInfluencers> createState() => _AddCardBusinessInfluencersState();
}

class _AddCardBusinessInfluencersState extends State<AddCardBusinessInfluencers> {
  String cardName = '';
  String cardNo = '';
  String date = '';
  String cvc = '';
                  ...
                  Padding(
                    ...
                    child: SecendoryButton(text: "Add Card", onPressed: (){
                      ...
                      if(cardName == '' || cardNo == '' || date == '' || cvc == ''){
                        ...
                        nextScreen(context, ChargingPage());
                      }
                    }),
                  )
                ],
