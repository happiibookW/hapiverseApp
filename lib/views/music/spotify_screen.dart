  ...
  Future<void> connectToSpotifyRemote() async {
    try {
      ...
      var result = await SpotifySdk.connectToSpotifyRemote(
          clientId: '37f575170a3640f68f7fe17fd25452e0',
        redirectUrl: Platform.isAndroid ?  'http://18.117.21.112/hapiverse/public/': 'spotify-ios-quick-start://spotify-login-callback',
      );
      setStatus(result
